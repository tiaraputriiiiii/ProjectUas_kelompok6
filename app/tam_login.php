...
<body style="margin-top: 30px; background-color: #ffff;">
    <div class="container" style= "background-color: #ffff; width: 30%; border-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.3); ">
        <h1 style="color: #00000; text-align: center;">Tambah Akun</h1>
        <div class="main">
            <form method="post" action="tam_login.php" enctype="multipart/form-data">    
                ...
                <div class="">
                    <h6 style="color: #00000;">Status</h6>
