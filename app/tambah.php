...
<body style="margin-top: 30px; background-color: #ffff;">
    <div class="container" style="background-color: #ffff; width: 50%; padding: 30px;">
        <h1 style="color: black; text-align: center;">Tambah Data</h1>
        <div class="main">
            <form method="post" action="tambah.php" enctype="multipart/form-data">
                ...
                <div class="input">
                    <label style="color: #00000;">Kloset</label>
                ...
                <div class="input">
                    <label style="color: #00000;">Wastafel</label>
                ...
                <div class="input">
                    <label style="color: #00000;">Lantai</label>
                ...
                <div class="input">
                    <label style="color: #00000;">Dinding</label>
                ...
                <div class="input">
                    <label style="color: #00000;">Kaca</label>
                ...
                <div class="input">
                    <label style="color: #00000;">Bau</label>
                ...
                <div class="input">
                    <label style="color: #00000;">Sabun</label>
